...
urlpatterns = [
    ...
    path("billing/interval", legacy_views.api_billing_interval, name="api_billing_interval_legacy"),
    path("billing/set-interval", legacy_views.api_billing_set_interval, name="api_billing_set_interval_legacy"),
    path("billing/currency", legacy_views.api_billing_currency, name="api_billing_currency_legacy"),
    path("billing/set-currency", legacy_views.api_billing_set_currency, name="api_billing_set_currency_legacy"),
